...
Run from this folder with:
    python cucina_backend.py --port 8086

Then open:
    http://127.0.0.1:8086/cucina.html
"""
...
DATA_FILE = BASE_DIR / "cucina-data.json"
...
def main() -> None:
    ...
    print(f"Serving cuisine backend on http://{args.host}:{args.port}/cucina.html")
