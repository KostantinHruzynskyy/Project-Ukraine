...
function setupTranslation() {
  ...
  const storedLanguage = localStorage.getItem("skyy-language");
  ...
  if (storedLanguage && storedLanguage !== savedLanguage) {
    localStorage.setItem("skyy-language", savedLanguage);
  }
...
function updateScrollEffects() {
  ...
  root.style.setProperty("--parallax-y", prefersReducedMotion.matches ? "0px" : `${Math.min(scrollTop * 0.18, 120)}px`);
}
